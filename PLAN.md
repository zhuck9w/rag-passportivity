...
- [ ] **Step 1: Падающие тесты `tests/test_retrieval.py`**
...
- [ ] **Step 4: Реализация `retrieval.py`**
...
- [ ] **Step 6: `scripts/ask.py` — главная проверка качества поиска**
...
- [ ] **Step 7: Прогнать 10–20 реальных вопросов** — это точка тюнинга качества всей системы:
